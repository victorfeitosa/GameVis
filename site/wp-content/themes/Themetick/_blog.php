    ...
    <div class="content left">
        <div class="wrapper">
            ...
            <?php
                ...
                $embed_code = wp_oembed_get($video_link, array('width'=>650));
                ...
                <div class="blog-one left">
                    ...
                    <div class="blog-comments-date left">
                        ...
                        <div class="blog-date left">-  <?php the_author_posts_link(); ?> on <?php echo get_the_date()?> in <?php echo get_the_category_list( ',', $post->ID ); ?> </div><!--/blog-date-->
