...
$meta_boxes = array(
    ...
    array(
        ...
        'fields' => array(
            array(
                'name' => __('Disable Title Banner', 'tkingdom'),
                'desc' => __('Check this box if you want to disable page title and breadcrumbs on this page.', 'tkingdom'),
