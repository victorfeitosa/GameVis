...
<div class="row-fluid footer-top">
    <div class="container">
        <h1><img src="<?php echo get_template_directory_uri()?>/img/newsleter-footer-title.png"><?php _e('Newsletter', 'tkingdom')?></h1>
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                <?php } elseif ($footer_newsletter_service == 'mailchimp') { ?>
                    <form id="signup" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" id="newsleter-form-footer">
