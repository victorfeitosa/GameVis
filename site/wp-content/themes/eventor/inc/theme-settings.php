...
function my_general_admin_scripts() {
   wp_enqueue_script('jquery-ui-datepicker', get_template_directory_uri() . '/script/datepicker/jquery-ui-1.10.1.custom.min.js');
   wp_enqueue_script('jquery-ui-timpicker', get_template_directory_uri() . '/script/timepicker/jquery.ui.timepicker.js');
}
...
function admincss() {
    ...
    wp_register_style('date-picker', get_template_directory_uri() . '/script/datepicker/datepicker.css');
    wp_enqueue_style('date-picker');
    
    wp_register_style('time-picker', get_template_directory_uri() . '/script/timepicker/jquery.ui.timepicker.css');
...
function includeScript() {
    ...
    <link rel="stylesheet" media="screen" href="<?php echo get_template_directory_uri().'/script/datepicker/jquery-ui-1.10.1.custom.min.css';?>" type="text/css" />
