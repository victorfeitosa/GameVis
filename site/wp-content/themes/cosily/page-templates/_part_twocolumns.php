...
<?php } 
// checks if testimonials are selected in page builder
elseif ($get_post_type == 'testimonials'){
            ...
            $testimonials_title_left = get_option('sub_testimonial_title_left-'.$post->ID);                
        ?>
        ...
        <div class="home-testimonials left">
            ...
            <?php
                ...
                $random_post_left = get_option('sub_check_testimonial_left-'. $post_id);
...
<?php } elseif($get_post_type == 'adbanner'){ 
                ...
                ?>
                <div class="home-content-ad  half-banner left">
        ...
        <?php } elseif($get_post_type == 'gallery') {
          ...
          //get gallery page id
            ...
            //gets gallery title                
            $gallery_title = get_option('sub_gallery_title_left-'.$post->ID);
            //gets number of posts from page builder 
            $gallery_post_num = get_option('sub_gallery_number_left-'.$post->ID);
...
<div class="half-width half-last left">

<?php
//right column

 if ($get_post_type_col_right == 'news') {
         //get number of posts and a category for news
    ...
    <div class="home-latest-news-rooms right">
            <div class="home-latest-news left">
...
<?php } 
//checks to see if testimonials are selected in page builder
elseif ($get_post_type_col_right == 'testimonials'){
    
            //get testimonials page id
            $testimonials_id = get_theme_option('id_testimonials_page');             
            //gets testimonial title                
            $testimonials_title = get_option('sub_testimonial_title_right-'.$post_id);                
        ?>
        ...
        <div class="home-testimonials left">
            ...
            <?php
                ...
                $random_post = get_option('sub_check_testimonial-'. $post_id);
...
<?php }
elseif($get_post_type_col_right== 'gallery' ) {
          ...
          //get gallery page id
            ...
            ?>
            <div class="horizontal-slider-wrap left">
                <div class="horizontal-slider right">
...
elseif($get_post_type_col_right == 'adbanner'){ 
                $ad_post = get_option('sub_bulder_banner_right-' . $post_id);                
                $custom_banner = get_post_meta($ad_post, $prefix.'custom_banner_code', true);
                $image_src = wp_get_attachment_image_src( get_post_thumbnail_id($ad_post), 'full' ); 
                //tk_add_banner_view($ad_post);
                ?>
                <div class="home-content-ad half-banner last-width left">
