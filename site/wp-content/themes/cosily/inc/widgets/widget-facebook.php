   ...
   function widget($args, $instance) {
       ...
       if($args['id'] == 'sidebar-1' || $args['id'] == 'sidebar-2' || $args['id'] == 'sidebar-3' ||  $args['id'] == 'sidebar-4'){
        ...
        <div class="facebook-widget">
            <iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $url; ?>&amp;width=<?php echo $fb_width; ?>&amp;height=<?php echo $fb_height; ?>&amp;colorscheme=light&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:<?php echo $fb_width; ?>px; height:<?php echo $fb_height; ?>px;" allowTransparency="true"></iframe>
        </div><!--  facebook widget-->
