...
<div id="main-wrapper">
    <div class="container <?php if($position_left == 'yes'){ echo 'left-aligned'; } ?>">
        <div class="row">
            <div class="shortcodes <?php if($sidebar_position == 'fullwidth'){echo '';}elseif($sidebar_position == 'left'){echo 'col-md-9 pull-right';}else{echo 'col-md-9';}?>">
                    ...
                    <div class="block contact-form">
                        <form method="GET" id="contact" class="comment-form" onsubmit="return checkForm(this)" action="<?php echo get_template_directory_uri().'/sendcontact.php'?>" >
                            <div class="row contact-name">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" onfocus="if(value==defaultValue)value=''" onblur="if(value=='')value=defaultValue" value="<?php if(isset($_GET['captcha']) && $_GET['captcha'] == 'error'){echo $_SESSION['contactemail'];}else{_e('E-mail', 'tkingdom');} ?>" name="email" id="contactemail" tabindex="2" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
