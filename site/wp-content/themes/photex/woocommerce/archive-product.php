...
get_header( 'shop' );
$sidebar_position = get_theme_option(wp_get_theme()->name . '_woocommerce_woo_page_sidebar');
...
<div id="main-wrapper">
	<div class="container <?php if($position_left == 'yes'){ echo 'left-aligned'; } ?>">
   		<div class="row">
    		<div class="<?php if($sidebar_position == 'fullwidth'){echo 'col-md-12 no-sidebar';}elseif($sidebar_position == 'left'){echo 'col-md-9 pull-right';}else{echo 'col-md-9';}?>">
