...
<div class="row-fluid shortcodes-margin">
    <div class="container">
        ...
        <div class="row-fluid">
            ...
            <div class="<?php if($sidebar_postition == 'fullwidth'){echo 'span12';}elseif($sidebar_postition == 'left'){echo 'right span8';}elseif($sidebar_postition == 'right'){echo 'left span8';}?> directors-page">

                <div class="block home-directors">
                    <?php
                    $paged = (get_query_var('paged')) ? get_query_var('paged') : 0;
                    $args = array('post_status' => 'publish', 'post_type' => 'team-members', 'paged' => $paged, 'posts_per_page' => get_option('posts_per_page'));
                    // The Query
