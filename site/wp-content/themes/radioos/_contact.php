                        ...
                        <div class="form right">                     
                            ...
                            <form method="POST" id="contactform" onsubmit="return checkForm(this)" action="<?php echo get_template_directory_uri().'/sendcontact.php'?>" >
                                <div class="form-input left">
                                    <div class="bg-input left"><span><?php _e('Name', tk_theme_name)?></span><input type="text" onfocus="if(value==defaultValue)value=''" onblur="if(value=='')value=defaultValue" value="" name="contactname" id="contactname" tabindex="2"/><div class="down-border-form left"></div><!--/down-border-form--></div>
                                    <div class="bg-input right"><span><?php _e('E-mail', tk_theme_name)?></span><input type="text" onfocus="if(value==defaultValue)value=''" onblur="if(value=='')value=defaultValue" value="" name="email" id="contactemail" tabindex="3"/><div class="down-border-form left"></div><!--/down-border-form--></div>
                                </div><!--/form-input-->
                                <div class="form-textarea">
                                    <span><?php _e('Message', tk_theme_name)?></span>
                                    <textarea onfocus="if(value==defaultValue)value=''" onblur="if(value=='')value=defaultValue" name="message" id="contactmessage" tabindex="4"></textarea><div class="down-border-form left"></div><!--/down-border-form-->
                                </div><!--/form-textarea-->

                                <div class="form-button left"><input class="search-submit-button" type="submit" name="submit" value="<?php _e('Send', tk_theme_name)?>" /></div>
