...
this.screenshotPreview = function(){
    ...
    jQuery(".image_wrap").hover(function(e){

            var img_link = jQuery('.img_link', this).val();
            ...
            jQuery("body").append("<div id='screenshot' style='position:absolute;'><img src='"+ img_link +"' alt='url preview' />"+ c +"</div>");
            jQuery("#screenshot")
                            ...
                            foreach ($r1 as $r2) {
                                ...
                                if ($row_items == 4) {
                                    if (count($r2) > 0) {
                                        ...
                                        if ($r3['type'] == 'headline') {//TYPE: headline
                                                ...
                                                echo '<tr>
                                                                        <th><h2>' . $required . '' . $r3['label'] . ' <div class="image_wrap" style="display:inline-block; margin:4px 0 0 0; float:right "><img class="image_helper" src="'.get_template_directory_uri().'/style/img/questionmark.png"><input type="hidden" class="img_link" value="'.$val.'" /></div></h2>'.$dev.'</a></th>
                                                                    </tr>';
                                            }
                                    ...
                                    $val = $r3['value'];
                                                ...
                                                echo '<tr>
                                                            ...
                                                            foreach ($posts as $post) {
                                                                if($val == $post->ID){$selected = 'selected';}else{$selected = '';};
