...
function update_notifier_menu() {
    ...
    if($notifier_data == ''){
        ...
        if(version_compare($theme_data['Version'], $tk_new_version) == -1) {
            add_theme_page( $theme_data['Name'] . 'Theme Updates', $theme_data['Name'] . '<span class="update-plugins count-1"><span class="update-count">'.$tk_new_version.'</span></span>', 'administrator', strtolower($theme_data['Name']) . '-updates', 'update_notifier');
        }
