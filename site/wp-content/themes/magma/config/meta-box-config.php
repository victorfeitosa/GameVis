...
$meta_boxes = array(
    ...
    array(
        'id' => 'slider_post_meta',
        'title' => __('Slider Post', 'tkingdom'),
        'pages' => array('post'), // multiple post types
        'context' => 'side',
        'priority' => 'high',
        'fields' => array(
            array(
                'name' => __('Slider Post', 'tkingdom'),
                'desc' => __('Check this box if you want to show this post in slider', 'tkingdom'),
    ...
    array(
        'id' => 'page_title',
        'title' => __('Page Title', 'tkingdom'),
        'pages' => array('page'), // multiple post types
        'context' => 'side',
        'priority' => 'high',
        'fields' => array(
            array(
                'name' => __('Disable Title', 'tkingdom'),
                'desc' => __('Check this box to disable title on this page', 'tkingdom'),
    ...
    /************************************************************/
    /*                                                          */
    /*   Metabox for post rating                                */
    /*                                                          */
    /************************************************************/
    array(
        'id' => 'post_rating',
        'title' => __('Rating', 'tkingdom'),
        'pages' => array('post'),
        'context' => 'normal',
        'priority' => 'high',
        'fields' => array(
            array(
                'name' => __('Enable post Rating', 'tkingdom'),
                'desc' => __('Check this if you want to enable rating system on this post. ', 'tkingdom'),
                'id' => $prefix . 'enable_rating',
                'type' => 'checkbox',
                'std' => ''
            ),
            array(
                'name' => __('Select Rating Position', 'tkingdom'),
                'desc' => __('Check this if you want to enable rating system on this post. ', 'tkingdom'),
            ...
            array(
                'name' => __('Total Score Label', 'tkingdom'),
                'desc' => __('', 'tkingdom'),
            ...
            array(
                'name' => __('Enable Reader Post Rating ', 'tkingdom'),
                'desc' => __('Check this if you want to enable users/readers to rate this post. ', 'tkingdom'),
