...
<div class="block bg-content single-post">
    ...
    <div class="container <?php if($sidebar_postition !== 'fullwidth' && !$check_image_single) { echo 'post-without-image'; } elseif($sidebar_postition == 'fullwidth' && !$check_image_single) { echo 'full-single-no-image'; } ?>">
        <div class="sc-fullwidth-holder row">
            <?php if(!empty($check_image_single)) { ?>
                <div id="preload-image"></div>
                <figure class="single-featured-image"><?php the_post_thumbnail('full-width-image'); ?></figure>
            <?php } ?>
    ...
    <div class="full-width-posts">
        <div class="block <?php if (is_sticky()) { echo 'featured-post'; } ?> <?php if( has_post_thumbnail()) { echo 'post-with-image'; } else { echo 'post-no-image'; } ?>">
                ...
                <?php if(has_post_thumbnail()){
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <a href="<?php the_permalink(); ?>" class="link-home-images"><img src="<?php echo $post_thumbnail_src; ?>" alt="<?php the_title()?>" title="<?php the_title()?>" />
                                <?php
                                    /*
                                     * RATING SYSTEM
                                     */
                        ...
                        <div class="col-xs-9 <?php if( !$post->post_excerpt ) { echo 'content-holder'; }?>">
                            <a href="<?php the_permalink(); ?>" class="full-post-title"><?php the_title()?></a>
                            <ul class="rating">
                                <?php get_template_part( '/templates/parts/entry', 'meta' ); ?>
                            </ul>
                                <?php
    ...
    <div class="col-xs-6">
        <div class="block post-with-image">
            <a href="<?php the_permalink()?>" class="link-home-images">
                <img src="<?php echo $post_thumbnail_src; ?>" alt="image" title="image" class="half-width-featured-image"/>
                <?php
                    /*
                     * RATING SYSTEM
                     */
