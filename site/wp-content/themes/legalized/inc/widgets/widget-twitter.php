...
class App_Twitter extends WP_Widget {
   ...
   function form($instance) {
       ...
       <p><b><?php _e('Twitter will not work unless you have set up Twitter authentication at ', tk_theme_name); ?><a target='_blank' href='<?php echo site_url(); ?>/wp-admin/admin.php?page=theme-settings&tab=social'><?php _e('theme administration', tk_theme_name); ?></a></b></p>
