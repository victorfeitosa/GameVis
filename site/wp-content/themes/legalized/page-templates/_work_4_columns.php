...
<section>
    <div class="container">
        ...
        <div class="row-fluid">
            ...
            <div class="work-single-content four-up pull-left isotope">
                <?php
                    $i = 1;
                        ...
                        <div class="<?php if (has_post_thumbnail()) { echo 'flipper'; } ?>">
                            <?php if (has_post_thumbnail()) { ?>
                                <div class="front rounded">
                                    <?php if (has_post_thumbnail() && $format == false) { the_post_thumbnail('work-4-column'); } ?>
                                </div>
                            <?php } ?>
                   ...
                   <?php } elseif ($format == 'gallery'){ 
                    ...
                    ?>
                        ...
                        <a href="<?php echo $slide_images[0]; ?>" rel="gallery" class="gallery_box<?php echo $i; ?>">                                            
                            <img src="<?php tk_get_thumb(407, 273, $slide_images[0]); ?>" alt="<?php the_title(); ?>" />
                            <div>
                                <span><?php the_title(); ?></span>
                                <p></p>
                            </div>
                        ...
                        <span style="display:none !important;">
                            ...
                            foreach(array_slice($slide_images, 1) as $the_image) { ?>
                                <a href="<?php echo $the_image; ?>" rel="gallery" class="gallery_box<?php echo $i; ?>" title="<?php echo the_title() ?>"><img src="<?php tk_get_thumb(407, 273, $slide_images[0]); ?>" /></a>
                            <?php } ?>
                        </span>
