...
/* Next and Prev arrows for Work Posts */
$prev_post = get_previous_post();
$next_post = get_next_post(); 

/* Sidebar position and select, based on Blog Page */
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($subheading !== '') { ?>
                            <h2 class="page_description"><?php echo $subheading ?></h2>
                        <?php } ?>
                    <?php } ?>
                </div>
            </div>
                ...
                <div id="content" class="<?php if($sidebar_postition == 'right'){echo 'span8 pull-left';}elseif($sidebar_postition == 'left'){echo 'span8 pull-right';}elseif($sidebar_postition == 'fullwidth'){echo 'span12';}?>">
                    ...
                    <div class="page" <?php echo $padding; ?>> 
                        ...
                        <?php //Enable Social Share
                            $social_share_work = get_theme_option(tk_theme_name . '_social_social_share_work');
                            if ($social_share_work != 'yes') { 
                        ?>
