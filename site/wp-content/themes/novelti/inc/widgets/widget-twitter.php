...
class App_Twitter extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p><b><?php _e('Twitter will not work unless you have set up Twitter authentication at '); ?><a target='_blank' href='<?php echo site_url(); ?>/wp-admin/admin.php?page=theme-settings&tab=social'>theme administration</a></b></p>
