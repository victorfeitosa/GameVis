...
function DotaDriver() {
  ...
  //jsons to our own servers and get them from there for now...
	...
	//TODO: replace this for a user steam key
	var steamKey = '1F70FCC84A7D9EDDE450DCDC1680FB11';
	...
	self.getPlayerSummary = function () {
		var url =
			'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/';
		url = url + '?key=' + steamKey;
		url = url + '&steamids=76561198036094790';
...
DotaDriver.prototype.buildData = function (src) {
	...
	var jsonobj = JSON.parse(httpGet(src));
