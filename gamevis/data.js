...
//GameDataFormat enum
var GameDataFormat = {};
GameDataFormat.XML = 1;
GameDataFormat.JSON = 2;
...
function GameData() {
	...
	self.loadDataBase = function (src, format) {
		//TODO: Implement this

	}

	self.saveDataBase = function (dest, format) {
		//TODO: Implement this
	...
	self.serialize = function () {
		var str = 'GameData{';
		str = str + self.GameId.toString() + ';';
		str = str + self.GameName.toString() + ';';
		str = str + self.GameCategory.toString() + ';';
		str = str + self.GameDescription.toString() + ';';
		//GameTeams
		str = str + '{';
		for (var i in self.GameTeams) {
			str = str + self.GameTeams[i] + ';';
		}
		str = str + '}';
		//GamePlayers
		str = str + '{';
		for (var i in self.GamePlayers) {
			str = str + self.GamePlayers[i] + ';';
		}
		str = str + '}';
		//GameMatchs
		str = str + '{';
		for (var i in self.GameMatchs) {
			str = str + self.GameMatchs[i] + ';';
		}
		str = str + '}}';
	...
	self.deserialize = function (str) {
		//This will overwrite all values of this class from the deserialized string
    //TODO: implement this
	}
}
