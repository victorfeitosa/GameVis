...
require_once(AQPB_PATH . 'blocks/aq-buttons-block.php');
...
require_once(AQPB_PATH . 'blocks/aq-toggle-block.php');
require_once(AQPB_PATH . 'blocks/aq-accordion-block.php');
require_once(AQPB_PATH . 'blocks/aq-upload-block.php');
require_once(AQPB_PATH . 'blocks/aq-advertisement-block.php');
//require_once(AQPB_PATH . 'blocks/aq-slider-block.php'); //Revolution slider
...
require_once(AQPB_PATH . 'blocks/aq-allslider-block.php');
require_once(AQPB_PATH . 'blocks/aq-allpost-types-block.php');
...
aq_register_block('AQ_Buttons_Block');
...
aq_register_block('AQ_Toggle_Block');
aq_register_block('AQ_Accordion_Block');
aq_register_block('AQ_Advertisement_Block');
//aq_register_block('AQ_Slider_Block'); //Revolution slider
aq_register_block('AQ_Title_Block');
aq_register_block('AQ_Image_Block');
aq_register_block('AQ_Testimonial_Block');
aq_register_block('AQ_Allslider_Block');
aq_register_block('AQ_AllPostTypes_Block');
