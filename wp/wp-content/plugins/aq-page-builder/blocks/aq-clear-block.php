	...
	function block($instance) {
		...
		switch($horizontal_line) {
			case 'none':
				break;
			case 'single':
				echo '<hr class="aq-block-clear aq-block-hr-single" style="background-color:'.$line_color.';border:none;height:'.$height.'px"/>';
				break;
			case 'double':
				echo '<hr class="aq-block-clear aq-block-hr-double" style="background:'.$line_color.'; height:'.$height.'px""/>';
				echo '<hr class="aq-block-clear aq-block-hr-single" style="background:'.$line_color.'; height:'.$height.'px""/>';
				break;
			case 'image':
