...
?>
    ...
    <link rel="stylesheet" media="screen" href="<?php echo get_template_directory_uri().'/script/datepicker/css/smoothness/jquery-ui-1.8.20.custom.css';?>" type="text/css" />
                                        ...
                                        foreach ($r2 as $r3) {
                                            ...
                                            if ($r3['type'] == 'file') {//TYPE: FILE
                                                if (get_option(tk_theme_name().'_'.$tab . '_' . $r3['name']) != '') {
                                                    ...
                                                    $val = $r3['value'];                                                                                                        
                                                    if(isset($val) && $r3['id'] == 'body_bg_img'){
                                                        $val ='';
                                                    }
                                                }
                                                echo '<tr valign="top">
                                            ...
                                            if ($r3['type'] == 'category') {//TYPE: dropdown Categories
                                                ...
                                                echo '<tr>
                                                 ...
                                                 if ($r3['type'] == 'taxonomy') {//TYPE: custom dropdown Categories
                                                if (get_option(tk_theme_name().'_'.$tab . '_' . $r3['name']) != '') {
                                                    $val = get_option(tk_theme_name().'_'.$tab . '_' . $r3['name']);
                                                } else {
                                                    $val = $r3['value'];
