        ...
        <div class="span4 ca-menu left">
            <div class="row-fluid">
                ...
                <style type="text/css">
                    ...
                    .ca-menu.left .ca-item:hover a.more_link span, .ca-menu.left .ca-item:hover h1, .ca-menu.left .ca-item:hover p{color: #<?php echo $tk_hover_color; ?> !important;}
                ...
                <div class="ca-item ca-item<?php echo $post->ID; ?> rounded"> 
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <div class="ca-content">
                            ...
                            <a class="more_link more_link_three" href="<?php the_permalink(); ?>"><span><?php echo __('Read More', tk_theme_name); ?></span></a>
                        </div>
                    </a>
                </div>
...
<?php if($get_post_type_col_center == 'services') {
        ...
        <div class="span4 ca-menu center">          
            <div class="row-fluid">             
                ...
                <style type="text/css">
                    .ca-menu .ca-item<?php echo $post->ID; ?>:hover {background-color: #<?php echo $tk_background_hover_color; ?>}
                    .ca-menu.center .ca-item:hover a.more_link span, .ca-menu.center .ca-item:hover h1, .ca-menu.center .ca-item:hover p{color: #<?php echo $tk_hover_color; ?> !important;}
...
<?php if ($get_post_type_col_right == 'services') {
        ...
        <div class="span4 ca-menu right">
            <div class="row-fluid">
                ...
                <style type="text/css">
                    .ca-menu .ca-item<?php echo $post->ID; ?>:hover {background-color: #<?php echo $tk_background_hover_color; ?>}
                    .ca-menu.right .ca-item:hover a.more_link span, .ca-menu.right .ca-item:hover h1, .ca-menu.right .ca-item:hover p{color: #<?php echo $tk_hover_color; ?> !important;}
