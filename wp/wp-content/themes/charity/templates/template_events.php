    ...
    <div class="row-fluid shortcodes-margin">
        ...
        <?php } ?>
            ...
            <div class="row-fluid">
                ...
                <div class="<?php if($sidebar_postition == 'fullwidth'){echo 'span12';}elseif($sidebar_postition == 'left'){echo 'right span8';}elseif($sidebar_postition == 'right'){echo 'left span8';}?> events-page">
                    <?php
                    $paged = (get_query_var('paged')) ? get_query_var('paged') : 0;
                    $args = array('post_status' => 'publish', 'post_type' => 'events', 'paged' => $paged, 'meta_key' => 'tk_event_datetime', 'orderby' => 'meta_value_num', 'order' => 'ASC', 'posts_per_page' => get_option('posts_per_page'));
                    // The Query
