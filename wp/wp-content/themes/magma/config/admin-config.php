    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label' => 'Header Logo',
                'desc' => 'JPEG, GIF or PNG image, 252x50 recommended up to 500KB',
            ),
            ...
            array(
                ...
                'type' => 'select',
                'value' => array(
                    array('Type One', 'header_one'), // ARRAY ('TITLE', 'VALUE')
                    array('Type Two', 'header_two'), // ARRAY ('TITLE', 'VALUE')
                    array('Type three', 'header_three'), // ARRAY ('TITLE', 'VALUE')
                ),
                'label' => 'Heder Type',
                'desc' => 'Select header type you wish to use <ul class="enlarge"><li><a>Type One</a><span><img src="'.get_template_directory_uri().'/theme-images/t1.jpg" alt="Deckchairs" /><br />Header Type One</span></li><li><a>Type Two</a><span><img src="'.get_template_directory_uri().'/theme-images/t2.jpg" alt="Blackpool sunset" /><br />Header Type Two</span></li><li><a>Type Three</a><span><img src="'.get_template_directory_uri().'/theme-images/t3.jpg" alt="Blackpool pier" /><br />Header Type Three</span></li></ul>',
            ),
            array(
                'id' => 'header_advert',
                'name' => 'header_advert',
                ...
                'label' => 'Header Banner',
                'desc' => 'Visible on header type two and three',
            ),
            ...
            array(
                ...
                'label' => 'Search/Tag/Author Sidebar',
                'desc' => 'Select sidebar position for Search, Tag and Author pages',
            ),
            array(
                'id' => 'cat_page_layout',
                'name' => 'cat_page_layout',
                'type' => 'select',
                'value' => array(
                    array('One Column', 'cat_layout_one'), // ARRAY ('TITLE', 'VALUE')
                    array('Two Columns', 'cat_layout_two'), // ARRAY ('TITLE', 'VALUE')
                ),
                'label' => 'Search/Tag/Author Layout',
                'desc' => 'Select layout you wish to use for Search, Tag and Author pages.',
            ),
            array(
                'id' => 'box_1_hr',
                'name' => 'box_1_hr',
            ...
            array(
                ...
                'type' => 'select',
                'value' => array(
                    array('MadMini', 'madmimi'), // ARRAY ('TITLE', 'VALUE')
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'text',
                'value' => '3',
                'label' => 'Number of slider posts',
                'desc' => 'Enter number of posts to show in slider(should be 3 or higher)',
                'options' => array(
                    'size' => '1'
                )
            ),            
            ...
            array(
                'id' => 'home_sidebar_pos',
                'name' => 'home_sidebar_pos',
                'type' => 'select',
                'value' => array(
                    array('Sidebar Right', 'home_sidebar_right'), // ARRAY ('TITLE', 'VALUE')
                    array('Sidebar Left', 'home_sidebar_left'), // ARRAY ('TITLE', 'VALUE')
                    array('Fullwidth', 'home_fullwidth'), // ARRAY ('TITLE', 'VALUE')
                ),
                'label' => 'Home Page sidebar position',
                'desc' => 'Select sidebar position for home page if you are using "Your latest posts" in settings',
            ),
            array(
                'id' => 'home_sidebar',
                'name' => 'home_sidebar',
                ...
                'post_type' => 'sidebars',
                'label' => 'Home Sidebar',
                'desc' => 'Select number of post columns on home page if you are using "Your latest posts" in settings',
            ),                   
            array(
                'id' => 'home_posts_layout',
                'name' => 'home_posts_layout',
                'type' => 'select',
                'value' => array(
                    array('One Column', 'cat_layout_one'), // ARRAY ('TITLE', 'VALUE')
                    array('Two Columns', 'cat_layout_two'), // ARRAY ('TITLE', 'VALUE')
                ),
                'label' => 'Number of posts columns',
                'desc' => 'Select number of post columns on home page if you are using "Your latest posts" in settings',
            ),
        ),
    ),
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'desc' => 'Enter LinkedIn account (e.g. www.linkedin.com/pub/themes-kingdom/) or leave empty if you dont wish to use LinkedIn',
                'options' => array(
                    'size' => '80'
                )
            ),
            ...
            array(
                ...
                'desc' => 'Enter YouTube account (e.g. themeskingdom) or leave empty if you dont wish to use YouTube',
                'options' => array(
                    'size' => '80'
                )
            ),
            ...
            array(
                ...
                'value' => '',
                'label' => 'Vimeo account',
                'desc' => 'Enter Vimeo account (e.g. themeskingdom) or leave empty if you dont wish to use Vimeo',
                'options' => array(
                    'size' => '80'
                )
            ),
    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'Check this box if you want to enable header shopping cart'
                ),
                'label' => 'Enable Header Shopping Cart',
                'desc' => '',
                'value' => '',
            ),
            ...
            array(
                ...
                'label' => 'Shop Page Sidebar Position',
                'desc' => 'Select sidebar position for shop page',
            ),
            ...
            array(
                ...
                'label' => 'Single Product Sidebar Position',
                'desc' => 'Select sidebar position for single product page',
            ),
        ),
    ),
);
