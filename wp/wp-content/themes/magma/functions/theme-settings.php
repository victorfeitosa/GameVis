...
// Function when advertisement is trashed to set the ad to "none"
function tk_update_ad_option() {
    global $post;
    if($post->post_type == 'advertisement') {
        update_option(wp_get_theme()->name.'_general_header_advert', 'none');
    }
}
add_action('publish_to_trash', 'tk_update_ad_option');

// end tk_update_ad_option
