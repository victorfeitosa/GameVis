...
class tk_Walker_Comment extends Walker_Comment {
            ...
            <article>            
                <header>
                    ...
                    <div class="comment-start-title right">
                        <span class="comment-heading"><?php echo get_comment_author_link(); ?></span>
                        <div class="meta-data">
    ...
    if (have_comments()) : ?>
        <section id="comments">
            <div class="design-home-title-top left"><?php comments_number( '0', '1', '%' ); ?> <?php _e('Comments','tkingdom')?></div>
            ...
            <?php else : ?>
                <div class="comment-form">
                    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform"  class="contact-form" onSubmit="return checkForm(this);">
                        <div class="design-home-title-top left"><?php _e('Leave a comment', 'tkingdom'); ?></div>
                        <?php if (is_user_logged_in()) : ?>
                            <p class="tk-comments-meta">
                        ...
                        <?php endif; ?>
                        <div class="control-group">
                            <div class="form-textarea input-prepend textarea-holder">
                        ...
                        <div class="control-group search-submit-button">
                            <div class="controls">
                                <button name="submit" class="cta" type="submit" id="submit" value="<?php _e('Submit Comment', 'tkingdom'); ?>"><?php _e('POST COMMENT', 'tkingdom')?></button>
                            </div>
                        </div>
