...
<div class="design-home-images-one left post-<?php echo $post->ID?>-<?php echo $post_id?>">
                ...
                <div class="flexslider">
                    <ul class="slides">
                        <?php foreach ($slide_images as $the_image) { ?>
                            <li><img src="<?php tk_get_thumb(630, 354, $the_image); ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" /></li>
    ...
    <?php } ?>
    <div class="design-home-images-one-title left margin-top-20"><a href="<?php the_permalink() ?>"><?php the_title() ?></a></div><!--/design-home-images-one-title-->
