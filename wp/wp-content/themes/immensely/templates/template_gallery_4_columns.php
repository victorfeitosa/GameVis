...
?>
    ...
    <div class="work four-col page" id="content">
                ...
                <div class="gallery-images-content">
                    ...
                    if ( have_posts() ) : while ( have_posts() ) : the_post();
                        ...
                        <?php }elseif($format == 'video'){
                            ...
                            ?>
                            <div class="span3 img-post <?php foreach($post_category as $post_cat){echo 'class-'.$post_cat->term_id.' ';}?> video-project">
                                    <figure>
                                        <?php if(!empty($image)){?>
                                        ...
                                        <div class="post-opt-wrapper">
                                            <div class="post-options <?php if($enable_single == 'no') { echo 'no-single'; } ?>">
                                                <a class="<?php if (!empty($pos_youtube)){echo 'youtube';}else{echo 'vimeo';}?> fancybox" href="<?php echo $video_link; ?>" title="<?php echo the_title() ?>"><i class="fa fa-play gallery-page"></i></a>
                                                <?php if($enable_single == 'yes') { ?><a href="<?php the_permalink()?>"><i class="fa fa-level-up"></i></a><?php } ?>
                                            </div>
                                        </div>
                                    </figure>
