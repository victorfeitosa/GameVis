...
define( 'tk_theme_name', 'elevation' );
...
add_theme_support( 'post-thumbnails' );                                         //This enables Post Thumbnails support for this theme.
        ...
        add_image_size( 'project-single', 635 , 9999);
...
function saveProjectId($post_ID) {
    ...
    if($post_ID == $oldblog) {
        ...
        if ( is_admin() && isset($_GET['activated'] ) && $pagenow == 'themes.php' ) {
            update_option('elevation_colors_header_bg_img', get_template_directory_uri().'/style/img/bg-header.jpg');
        }
