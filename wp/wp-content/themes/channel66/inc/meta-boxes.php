...
$meta_boxes = array(
    ...
    array(
        'id' => 'post_meta1',
        'title' => __('Post Views', tk_theme_name()),
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Post Views', tk_theme_name()),
                'desc' => '',
                'id' => $prefix . 'views',
                'type' => 'text',
                'std' => ''
    ...
    array(
        'id' => 'post_meta2',
        'title' => __('Page Custom Color', tk_theme_name()),
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Page Custom Color', tk_theme_name()),
                'desc' => 'Chose Color for Title section for this page',
                'id' => $prefix . 'color',
                'type' => 'colorpicker',
                'std' => '5F5F5F'
            )
    ...
    function show() {
        ...
        foreach ($this->_meta_box['fields'] as $field) {
            ...
            switch ($field['type']) {
                ...
                case 'text':
                    echo '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', $meta ? $meta : $field['std'], '" size="30" style="width:97%" readonly="readonly"/>',
                        '<br />', $field['desc'];
                    break;
