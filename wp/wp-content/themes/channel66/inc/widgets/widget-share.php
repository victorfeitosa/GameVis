...
<div class="sharewidget">
    <ul>
        <li>
            <div class="sharewidget-content" style="margin:0 3px 0 -3px; padding-top: 10px">
                <!-- PINTEREST -->
                <?php 
                global $post; ?>
    ...
    <ul>
        <li>
            <div class="sharewidget-content" style="position:relative; margin:0 0 0 -3px;">
                <!-- facebook -->
        ...
        <li style="margin-right: 0!important;">
            <div class="sharewidget-content" style="text-align:center">
                <!--  stumble upon -->
