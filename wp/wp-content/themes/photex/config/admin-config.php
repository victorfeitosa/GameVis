    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label' => 'Header Logo',
                'desc' => 'JPEG, GIF or PNG image, 237x57 recommended up to 500KB',
            ),
            array(
                'id' => 'box_1_hr',
                'name' => 'box_1_hr',
            ...
            array(
                ...
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'Check this box to align website content to the left'
                ),
                'label' => 'Align website content to the left',
                'desc' => '',
                'value' => '',
            ),
            array(
    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'Check this box to remove Black & White Filter on images from gallery page'
                ),
                'label' => 'Remove B&W image filter',
                'desc' => '',
                'value' => '',
            ),
            array(
                'id' => 'number_of_gallery_posts',
                'name' => 'number_of_gallery_posts',
                'type' => 'text',
                'value' => '',
                'std' => '14',
                'label' => 'Number of Full Screen Gallery posts to display',
                'desc' => 'Enter number of posts you want to display on Gallery page template (default is 14)',
                'options' => array(
                    'size' => '2'
                )
            ),
            array(
                'id' => 'number_of_gallery_fs_posts',
                'name' => 'number_of_gallery_fs_posts',
                'type' => 'text',
                'value' => '',
                'std' => '6',
                'label' => 'Number of Gallery posts to display',
                'desc' => 'Enter number of posts you want to display on Gallery Full Screen page template (default is 6)',
                'options' => array(
                    'size' => '2'
                )
            ),
            ...
            array(
                ...
                'type' => 'select',
                'value' => array(
                    array('Disable Single Post', 'no'), // ARRAY ('TITLE', 'VALUE')
                    array('Enable Single Post', 'yes'), // ARRAY ('TITLE', 'VALUE')
                ),
                'label' => 'Enable / Disable Single Post',
                'desc' => 'Select to enable or disable single post for Gallery Page. ',
            ),
                        //Related posts
        array(
            'id' => 'box_1_hr',
            ...
            array(
                ...
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'Disable Related Posts in single gallery'
                ),
                'label' => 'Disable Related Posts',
                'desc' => 'If this box is checked you will disable Related posts section in single gallery.',
                'value' => '',
            ),*/
        ),
    ),
